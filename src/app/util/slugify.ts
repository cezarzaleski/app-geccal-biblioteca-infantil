...
export function slugify(string: string, _options?: | { replacement?: string; remove?: RegExp; lower?: boolean; } | string): string {
  if (typeof string !== 'string') {
    throw new Error('slugify: string argument expected');
  }

  const options = (typeof _options === 'string') ? { replacement: _options } : _options || {};
